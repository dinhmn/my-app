  ...
  return (
    <ModalBase {...props}>
      <div className="modal-content bg-white relative z-10 p-10 rounded-lg w-full max-w-[482px]">
        <span
          className="absolute top-0 right-0 cursor-pointer w-[38px] h-[38px] rounded-full bg-white flex items-center justify-center p-1 -translate-y-2/4 translate-x-2/4"
