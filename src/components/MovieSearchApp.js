...
// https://api.themoviedb.org/3/movie/550?api_key=b6ab63ccaf8f3a111608500c7c803ceb
// https://api.themoviedb.org/3/search/movie?api_key=b6ab63ccaf8f3a111608500c7c803ceb&query=%27%27
  ...
  useEffect(() => {
    async function fetchdata() {
      ...
      const response = await axios.get(
        `https://api.themoviedb.org/3/search/movie?api_key=b6ab63ccaf8f3a111608500c7c803ceb&query='${queryDebounce}'`
      );
      ...
      <div className="p-7 flex-1 flex flex-col">
        ...
        <div className="flex item-center gap-x-3 mt-auto">
          ...
          <span className="text-sm font-semibold text-[#333]">
            <LoadingSkeleton height="15px" width="50px"></LoadingSkeleton>
          </span>
        </div>
      </div>
    </div>
        ...
        <img
          src={
            data.poster_path !== null
              ...
              : "https://images.unsplash.com/photo-1644527623623-ef33b900e088?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80"
          }
          alt=""
